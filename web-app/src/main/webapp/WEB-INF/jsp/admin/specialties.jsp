...
<head>
    ...
    <body class="admin-info-body">
        <div class="admin-info-header">
            <h5>
                <a class="p-2" href="<c:url value="/admin/addSpecialty"/>">
                    <spring:message code="add.specialty"/>
                </a>
            </h5>
        </div>
        <c:choose>
            <c:when test="${not empty objects}">
                <div class="admin-info-container">
                    <c:forEach var="specialty" items="${objects}">
                        <div>
                            ...
                            <h6>
                                <div class="delete-box">
                                    <b class="delete-element">
                                        ...
                                        <div>
                                            <a href="<c:url value="/admin/editSpecialty/${specialty.specialtyName}"/>">

...
<div class="admin-info-header">
    <h5>
        <a class="p-2 text-dark" href="<c:url value="/admin/specialties"/>">
...
<div class="admin-info-container">
    <div class="edit-info-container">
        <c:url value="/admin/editSpecialty/${specialty.specialtyName}/post" var="postPath"/>
        <form:form modelAttribute="specialtyForm" action="${postPath}" method="post">
            <h6>
                <div>
                    <form:label path="name"><spring:message code="name"/> </form:label>
                    <form:input type="text" path="name" placeholder="${specialty.specialtyName}"/>

...
<html>
    ...
    <body class="admin-info-body">
        <div class="admin-info-header">
            <h5>
                <a class="p-2" href="<c:url value="/admin/addPrepaidToClinic"/>">
                    <spring:message code="add.prepaid.to.clinic"/>
                </a>
            </h5>
        </div>
        <c:choose>
            <c:when test="${not empty objects}">
                <div class="admin-info-container">
                    <c:forEach var="prepaidClinic" items="${objects}">
                        <div>
                ...
                <div class="pagination">
                    <h6 class="prev">
                        <c:if test="${page > 0}">
                            <a  href="<c:url value="/admin/prepaidClinics/${page-1}"/>">
